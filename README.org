...
While documenting the function can help, documentation can be wrong, incomplete or just plain missing, while the source code itself is - by definition - the truth.
